...
Mezo DeFi integrates real-time price feeds, advanced analytics, and cross-protocol arbitrage monitoring to deliver professional-grade market intelligence and automated execution. By combining capital-efficient lending with live insights and arbitrage opportunities, Mezo DeFi empowers users to optimize yield, manage risk, and automate portfolio strategies — all while leveraging the security, transparency, and trust guarantees of Bitcoin.

- Bitcoin-native DeFi application
...
VITE_MEZO_VALIDATION_CLOUD_HTTP_RPC_URL=""

VITE_MEZO_BOAR_NETWORK_WS_RPC_URL=""
